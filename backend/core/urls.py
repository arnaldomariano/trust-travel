...
from .views import (
    ...
    BusinessPresenceLinkCreateView,
    BusinessPresenceLinkDetailView,
    ...
    ProfessionalContributionListCreateView,
    ProfessionalContributionDetailView,
...
urlpatterns = [
    ...
    path(
        "geography/cities/materialize/",
        GeographyCityMaterializeView.as_view(),
    ),
    path(
        "geography/pois/search/",
        GeographyPOISearchView.as_view(),
    ),
    path(
        "geography/pois/materialize/",
        GeographyPOIMaterializeView.as_view(),
    ),
    path(
        "geography/pois/create-manual/",
        GeographyPOIManualCreateView.as_view(),
    ),
    ...
    path(
        "business-presences/<int:presence_id>/links/",
        BusinessPresenceLinkCreateView.as_view(),
    ),

    path(
        "business-presences/<int:presence_id>/links/<int:link_id>/",
        BusinessPresenceLinkDetailView.as_view(),
    ),
    ...
    path(
        "professional-presences/<str:public_code>/",
        ProfessionalPresencePublicView.as_view(),
    ),
    path(
        "professional-presences/<str:public_code>/feed-mute/",
        ProfessionalFeedMuteView.as_view(),
    ),
    path(
    ...
    path(
        ...
        ProfessionalContributionPublicListView.as_view(),
    ),
    path(
    ...
    path(
        "professional-presence/business-relationships/",
        ProfessionalBusinessRelationshipListCreateView.as_view(),
    ),
    path(
        "professional-contributions/",
        ProfessionalContributionListCreateView.as_view(),
    ),
    path(
        "professional-contributions/<int:contribution_id>/",
        ProfessionalContributionDetailView.as_view(),
    ),
    path(
        "professional-presence/business-relationships/<int:relationship_id>/",
        ProfessionalBusinessRelationshipDetailView.as_view(),
    ),
    path(
    ...
    path(
        "trip-plans/<int:pk>/updates/<int:update_id>/",
        TripPlanUpdateView.as_view(),
    ),
    ...
    path("gallery/seen/", MarkGallerySeenView.as_view(), name="gallery-seen"),
    path(
